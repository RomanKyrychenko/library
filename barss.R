...
staircase.plot(sales$value,
  totals = c(F, F, F, F, F, F, F, F), labels =
    sales$labels, total.col = c("lightgreen"),
  inc.col = c("red", "red", "lightgreen", "lightgreen", "red", "lightgreen", "red", "red"),
...
staircase.plot(sample_size, totals, labels,
  main = "Зміна позиції України у рейтингу конкурентоспроможності ВЕФ",
