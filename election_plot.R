...
re <- exp2014par %>% filter(age=="18-29") %>% do_(golos=table(golos))
ddply(exp2014par,)
...
nas <- data_frame(gr=c("18-29","30-39","40-49","50-59","60+"),
...
yavka <- data_frame("вибори"=c("Парламентські вибори 2014", "Президентські вибори 2014", "Парламентські вибори 2012", "Президентські вибори 2010 І тур", "Президентські вибори 2010 ІІ тур", "Парламентські вибори 2007", "Парламентські вибори 2006"),
