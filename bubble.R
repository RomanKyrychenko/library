...
Bubble <- gvisBubbleChart(GCIs,
  idvar = "Global Competitiveness Index",
  xvar = "2016-2017",
  yvar = "changes",
  colorvar = "Країна",
  sizevar = "Score1",
  options = list(
    hAxis = '{title : "Позиція в рейтингу за 2016-2017 роки"}',
...
Bubble <- gvisBubbleChart(gci_rating,
  idvar = "Global Competitiveness Index", xvar = "Score1",
...
Bubble <- gvisBubbleChart(gci_rating,
  idvar = "Global Competitiveness Index", xvar = "GDP per Capita 2015 current $",
...
bub1 <- gvisBubbleChart(gci_rating,
  idvar = "Global Competitiveness Index", xvar = "2016-2017",
  yvar = "Середні коливання індексу 2006-2016", sizevar = "Score1",
  options = list(
    legend = "none", width = 900, height = 600, title
...
df <- data_frame(
  country = c("2006-2007", "2007-2008", "2008-2009", "2009-2010", "2010-2011", "2011-2012", "2012-2013", "2013-2014", "2014-2015", "2015-2016", "2016-2017"),
